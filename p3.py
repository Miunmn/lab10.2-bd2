...
if __name__ == "__main__":
    ...
    # print(knn_search_sequential_pq(3, face_recognition.face_encodings(face_recognition.load_image_file('lfw-a/lfw/Aaron_Eckhart/Aaron_Eckhart_0001.jpg'))[0], 50))
    # print("knn_search_rtree: ")
    # print(knn_search_rtree(3, face_recognition.face_encodings(face_recognition.load_image_file('lfw-a/lfw/Aaron_Eckhart/Aaron_Eckhart_0001.jpg'))[0]))
    # print("range_search_rtree: ")
    # print(range_search_rtree(face_recognition.face_encodings(face_recognition.load_image_file('lfw-a/lfw/Aaron_Eckhart/Aaron_Eckhart_0001.jpg'))[0], 3.0 ))
